...
export function Header({ isSidebarOpen }: HeaderProps) {
  ...
  return (
    <div
      id="header"
      className={clsx(
        'border-b h-14 border-notes-600 py-[1.125rem] px-6 flex items-center gap-4 leading-tight transition-all duration-250 region-drag',
        {
    ...
    >
      <Collapsible.Trigger
        className={clsx('h-5 w-5 text-notes-200 hover:text-notes-50', {
        ...
        <>
          ...
          <div className="inline-flex region-no-drag">
            <button
              ...
              className="inline-flex items-center gap-1 text-notes-100 text-sm hover:text-notes-50 disabled:opacity-60"
            >
